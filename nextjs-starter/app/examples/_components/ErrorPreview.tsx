...
import {
  ...
  BamlValidationError,
} from '@boundaryml/baml/errors';
import { AlertCircle } from 'lucide-react';

const getErrorMessage = (
  error: BamlValidationError | BamlClientFinishReasonError | Error,
) => {
        ...
        <div className="space-y-4">
          <section>
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md p-3">
              <pre className="text-sm text-red-900 dark:text-red-300 whitespace-pre-wrap break-words font-mono">
                {error.message}
              </pre>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md p-3">
              <pre className="text-sm text-red-900 dark:text-red-300 whitespace-pre-wrap break-words">
                {error.raw_output}
              </pre>
            </div>
          </section>
