...
export const Content: React.FC<{
	...
	setResumeText: (value: string) => void;
	isLoading: boolean;
	structured: StreamingHookResult<"ExtractResume">;
	unstructured: StreamingHookResult<"ExtractResumeNoStructure">;
...
function ResumeTabContent<T extends ActionKey>({
	state,
	renderComponent,
	mode,
}: {
	...
	renderComponent: (props: {
		resume: HookResultData<T> | HookResultPartialData<T>;
	}) => JSX.Element;
}) {
	const content = (data: HookResultData<T> | HookResultPartialData<T>) => {
		if (mode === "pretty") {
