...
export const Content: React.FC<{
  ...
  const state = answer.isPending
    ? answer.partialData?.instructions?.length
      ? 'instructions'
      : 'ingredients'
  ...
  return (
    <div className='bg-gradient-to-b from-blue-50 to-white py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-6xl mx-auto'>
        <h1 className='text-5xl font-bold text-center text-blue-900 mb-8'>Recipe Wizard</h1>
              ...
              <CardContent>
                <div className='flex flex-col gap-4'>
                  <div className='flex flex-col sm:flex-row gap-4'>
                    ...
                    >
                      {answer.isPending ? <Loader2 className='mr-2 h-4 w-4 animate-spin' /> : 'Generate Recipe'}
                    </Button>
                  </div>
                  <div>
