...
class BamlStreamClient {
  ...
  AnalyzeVanSide(
      vanImage: Image,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<VanSideAnalysis>, VanSideAnalysis> {
    try {
      const raw = this.runtime.streamFunction(
        "AnalyzeVanSide",
        {
      ...
      return new BamlStream<RecursivePartialNull<VanSideAnalysis>, VanSideAnalysis>(
        raw,
        (a): a is RecursivePartialNull<VanSideAnalysis> => a,
  ...
  GenerateGuide(
      arg: string,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<Guide>, Guide> {
    try {
      const raw = this.runtime.streamFunction(
        "GenerateGuide",
        {
      ...
      return new BamlStream<RecursivePartialNull<Guide>, Guide>(
        raw,
        (a): a is RecursivePartialNull<Guide> => a,
        (a): a is Guide => a,
        this.ctx_manager.cloneContext(),
        __baml_options__?.tb?.__tb(),
      )
  ...
  IdentifyVehicleSide(
      vanImage: Image,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry }
  ): BamlStream<RecursivePartialNull<VehicleSideResponse>, VehicleSideResponse> {
    try {
      const raw = this.runtime.streamFunction(
        "IdentifyVehicleSide",
        {
      ...
      return new BamlStream<RecursivePartialNull<VehicleSideResponse>, VehicleSideResponse>(
        raw,
        (a): a is RecursivePartialNull<VehicleSideResponse> => a,
