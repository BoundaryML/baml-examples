  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-transparent focus-visible:ring-2 focus-visible:ring-[rgba(37,99,235,0.5)] focus-visible:shadow-[0_0_0.3rem_#ffffff70]",
        "focus-visible:bg-gradient-to-r focus-visible:from-blue-600/10 focus-visible:to-purple-600/10",
