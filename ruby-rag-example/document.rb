...
SpaceX originally intended to follow its light Falcon 1 launch vehicle with an intermediate capacity vehicle, the Falcon 5.[42] The company instead decided in 2005 to proceed with the development of the Falcon 9, a reusable heavier lift vehicle. Development of the Falcon 9 was accelerated by NASA, which committed to purchasing several commercial flights if specific capabilities were demonstrated. This started with seed money from the Commercial Orbital Transportation Services (COTS) program in 2006.[43] The overall contract award was $278 million to provide development funding for the Dragon spacecraft, Falcon 9, and demonstration launches of Falcon 9 with Dragon.[43] As part of this contract, the Falcon 9 launched for the first time in June 2010 with the Dragon Spacecraft Qualification Unit, using a mockup of the Dragon spacecraft.
...
SpaceX launched the first commercial mission for a private customer in 2013. In 2014, SpaceX won nine contracts out of the 20 that were openly competed worldwide.[56] That year Arianespace requested that European governments provide additional subsidies to face the competition from SpaceX.[57][58] Beginning in 2014, SpaceX capabilities and pricing also began to affect the market for launch of U.S. military payloads, which for nearly a decade had been dominated by the large U.S. launch provider United Launch Alliance (ULA).[59] The monopoly had allowed launch costs by the U.S. provider to rise to over $400 million over the years.[60] In September 2014, NASA's Director of Commercial Spaceflight, Kevin Crigler, awarded SpaceX the Commercial Crew Transportation Capability (CCtCap) contract to finalize the development of the Crew Transportation System. The contract included several technical and certification milestones, an uncrewed flight test, a crewed flight test, and six operational missions after certification.[47]

In January 2015, SpaceX raised $1 billion in funding from Google and Fidelity Investments, in exchange for 8.33% of the company, establishing the company valuation at approximately $12 billion.[61] The same month SpaceX announced the development of a new satellite constellation, called Starlink, to provide global broadband internet service with 4,000 satellites.[62]
...
SpaceX first achieved a successful landing and recovery of a first stage in December 2015 with Falcon 9 Flight 20.[64] In April 2016, the company achieved the first successful landing on the autonomous spaceport drone ship (ASDS) Of Course I Still Love You in the Atlantic Ocean.[65] By October 2016, following the successful landings, SpaceX indicated they were offering their customers a 10% price discount if they choose to fly their payload on a reused Falcon 9 first stage.[66]
...
In March 2017, SpaceX launched a returned Falcon 9 for the SES-10 satellite. This was the first time a re-launch of a payload-carrying orbital rocket went back to space.[70] The first stage was recovered again, also making it the first landing of a reused orbital class rocket.[71]
2017–2018: Leading global commercial launch provider

In July 2017, the company raised $350 million, which raised its valuation to $21 billion.[72] In 2017, SpaceX achieved a 45% global market share for awarded commercial launch contracts.[73] By March 2018, SpaceX had more than 100 launches on its manifest representing about $12 billion in contract revenue.[74] The contracts included both commercial and government (NASA/DOD) customers.[75] This made SpaceX the leading global commercial launch provider measured by manifested launches.[76]
...
In 2019 Spacex raised $1.33 billion of capital across three funding rounds.[81] By May 2019, the valuation of SpaceX had risen to $33.3 billion[82] and reached $36 billion by March 2020.[83]
...
In January 2019, SpaceX announced it would lay off 10% of its workforce to help finance the Starship and Starlink projects.[103] The purpose of the Starship vehicle is to enable large-scale transit of humans and cargo to the Moon, Mars, and beyond.[104] Spacex's Starship is the largest and most powerful rocket ever flown, with a payload capacity of 100+ tons.[105][106] Construction of initial prototypes and tests for Starship started in early 2019 in Florida and Texas. All Starship construction and testing moved to the new SpaceX South Texas launch site later that year.
